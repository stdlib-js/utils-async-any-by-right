...
```javascript
import anyByRightAsync from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-any-by-right@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/utils-async-any-by-right/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/utils-async-any-by-right/actions/workflows/test.yml?query=branch:v0.2.1
